...
import com.imsdk.imdeveloper.ui.activity.ActionItem;
...
//		Log.e("", "333  " + (mLocation[1]));
	...
	public static interface OnItemAdapterOnClickListener {
		public void onItemClick(ActionItem item, int itemPos, int listPos);
	}
}
