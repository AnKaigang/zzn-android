...
import com.imsdk.imdeveloper.http.httpGetNotigy;
...
public class MainActivity extends FragmentActivity {
	...
	private int[] mItemCheckedImage = { R.drawable.tab_news_,
			...
			R.drawable.tab_me_ };
	private String[] mItemText = { "消息", "联系人", "动态", "我" };

	private ArrayList<Fragment> mFragmentsList;
	private InputMethodManager mInputMethodManager;
	private HomeWatcher mHomeWatcher;
	private Button mCreatTopic;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new httpGetNotigy(MainActivity.this).execute();
		...
		mTitleBarRightView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mShowingGroupMessage) {
					...
					// mTitle1BarRightView.setText("群消息");
				}
			}
		});
	}
