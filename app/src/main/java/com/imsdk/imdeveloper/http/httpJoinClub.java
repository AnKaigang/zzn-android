 ...
 */
public class httpJoinClub extends AsyncTask<String,String,String> {
    String result="";
    Activity activity;
    public httpJoinClub(Activity a){
        activity=a;
    }
    ...
    protected String doInBackground(String... params) {
        try {
            String path = IMConfiguration.ip+"joinCommunity.html?relation=" + URLEncoder.encode(params[0].toString(), "utf-8");
    ...
    protected void onPostExecute(String s) {
        ...
        if (s.equals("服务器异常")) {
            ...
            UICommon.showTips(activity, R.drawable.tips_smile, "加入成功");
        }
