 ...
 */
public class httpDownloadFile extends AsyncTask<String,String,String> {


    String result="";
    Activity activity;
    public httpDownloadFile(Activity a){
        activity=a;
    }
    ...
    protected String doInBackground(String... params) {
        try {
            String path = IMConfiguration.ip+"download.html?fileid=" + URLEncoder.encode(params[0].toString(), "utf-8");
