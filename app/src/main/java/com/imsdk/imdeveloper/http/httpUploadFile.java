 ...
 */
public class httpUploadFile extends AsyncTask<String,String,String> {


    String result="";
    Activity activity;
    public httpUploadFile(Activity a){
        activity=a;
    }
    ...
    protected String doInBackground(String... params) {
        try {
            String path = IMConfiguration.ip+"upload.html?communityid=" + URLEncoder.encode(params[0].toString(), "utf-8");
