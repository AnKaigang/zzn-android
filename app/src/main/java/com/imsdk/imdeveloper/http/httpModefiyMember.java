 ...
 */
public class httpModefiyMember extends AsyncTask<String, String, String> {
    String result = "";
    Activity activity;

    public httpModefiyMember(Activity a) {
        activity = a;
    }
    ...
    protected String doInBackground(String... params) {
        try {
            String path = IMConfiguration.ip+"editRlation.html?rlation=" + URLEncoder.encode(params[0].toString(), "utf-8");
